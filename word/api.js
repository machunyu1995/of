...
background-repeat: no-repeat;\
	...
	asc_docs_api.prototype.ViewScrollToYWithDebounce = function(y, delay)
	{
		delay = delay || 100; // 默认100ms防抖延迟
		
		// 使用现有的UpdateTargetTimer机制来实现防抖
		var drawingDocument = this.WordControl.m_oDrawingDocument;
		if (!drawingDocument) {
			return this.ViewScrollToY(y);
		}
		
		// 清除之前的定时器
		if (drawingDocument.m_lTimerUpdateTargetID !== -1) {
			clearTimeout(drawingDocument.m_lTimerUpdateTargetID);
			drawingDocument.m_lTimerUpdateTargetID = -1;
		}
		
		var self = this;
		var scrollApi = this.WordControl.m_oScrollVerApi;
		
		// 设置防抖定时器
		drawingDocument.m_lTimerUpdateTargetID = setTimeout(function() {
			drawingDocument.m_lTimerUpdateTargetID = -1;
			scrollApi.scrollToY(y);
		}, delay);
	};
    ...
    asc_docs_api.prototype.asc_isViewMode = function(){
	    return this.isViewMode;
	};


	asc_docs_api.prototype.asc_setSysCommentVisible = function(visible)
	{
		this.sysCommentVisible = visible;
	};

	asc_docs_api.prototype.asc_getSysCommentVisible = function(idx)
	{
		return this.sysCommentVisible;
	};
...
/*		const oController = this.getGraphicController();
	...
	asc_docs_api.prototype['ViewScrollToYWithDebounce']                 = asc_docs_api.prototype.ViewScrollToYWithDebounce;
    ...
    asc_docs_api.prototype['asc_isViewMode']                           = asc_docs_api.prototype.asc_isViewMode;
    ...
    asc_docs_api.prototype["asc_setSysCommentVisible"] = asc_docs_api.prototype.asc_setSysCommentVisible;

    asc_docs_api.prototype["asc_getSysCommentVisible"] = asc_docs_api.prototype.asc_getSysCommentVisible;
	...
	asc_docs_api.prototype["RegisterCommentSupport"] = function (func){
		window.commentSupport = func
	};
